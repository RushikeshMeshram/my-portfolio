            ...
            {navLinks.map(({ href, label }) => {
              ...
              return (
                <li key={href}>
                  <Link
                    href={href}
                    className={`hover:text-blue-600 dark:hover:text-blue-400 transition ${isActive ? "active" : ""}`}
                  >
                    {label}
                  </Link>
                </li>
            ...
            <ul className="px-4 py-4 space-y-1">
              {navLinks.map(({ href, label }) => {
                ...
                <li key={href}>
                  <Link
                    href={href}
                    className={`block py-3 px-4 text-lg font-medium rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition ${isActive ? "active" : ""}`}
                    onClick={closeMobileMenu}
                  >
                    {label}
                  </Link>
