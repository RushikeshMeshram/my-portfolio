...
export default function HeroSection({
  ...
  return (
    <section
      className="min-h-[calc(100dvh-4rem)] flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 py-12 sm:py-16"
      style={{
    ...
    >
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center w-full">
        ...
        <div className="text-lg sm:text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-6 sm:mb-8 break-words">
          <PortableText value={subheadline} components={components} />
        </div>
        {ctaLink && (
          <Link
            href={ctaLink}
