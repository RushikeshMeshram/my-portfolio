...
export default function HeroSection({ headline, subheadline, ctaText, ctaLink, backgroundImage }: HeroProps) {
  ...
  : "";
  return (
    <section className="min-h-[calc(100dvh-4rem)] flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 py-12 sm:py-16" style={{ backgroundImage: `url(${urlFor(backgroundImageUrl).url()})` }}>
